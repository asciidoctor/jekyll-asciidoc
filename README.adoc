...
Since Asciidoctor Diagram writes to the output folder, you have to instruct Jekyll not to remove these generated files.
...
CAUTION: At this time, GitLab Pages only work with projects hosted at GitLab.com or on self-hosted GitLab Enterprise Edition instances. GitLab Community Edition does not support continuous inetegration and cannot host pages.
