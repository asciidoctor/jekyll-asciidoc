...
Using these placeholder values prevents initialization from being performed more than once when using the `serve` command (see https://github.com/jekyll/jekyll/issues/4858[issue jekyll#4858]).
...
Since version 2.1.0, you can remove a previously defined attribute by prefixing the name with a hyphen (aka minus):
