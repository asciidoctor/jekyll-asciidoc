...
image:https://ci.appveyor.com/api/projects/status/3cf1f8p2cyoaoc25/branch/master?svg=true&passingText=green%20bar&failingText=%23fail&pendingText=building[Build Status (AppVeyor), link={uri-ci-appveyor}]
endif::[]
