...
* Indent conditions, method arguments or ternary expressions that span more than one line using 4 spaces (but not data structures or chained method calls).
...
* Use parentheses where required, such as around initial accumulator value for predicates.
