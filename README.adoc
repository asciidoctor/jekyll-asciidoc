...
To use this plugin, you must be using Jekyll >= 3.0.0 and Ruby >= 2.1.0 (with development headers installed).
...
TIP: When using this setup, don't forget to add the [.path]_.nojekyll_ file to the root of the source to tell GitHub Pages not to waste time running Jekyll again on the server.
