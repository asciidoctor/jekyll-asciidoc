...
{uri-repo}/tree/2.1.x#readme[2.1.x]
&hybull;
...
=== Disabling Publishing by Page

The prevent a page from being published, set the page attribute named `page-published` to `false` (which, in turn, sets the page variable named `published` to `false`.
