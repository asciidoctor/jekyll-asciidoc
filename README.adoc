...
The part of the name after the `page-` prefix is _lowercased_ and used as the variable's name (e.g., page-layout becomes layout) and the value is processed as {uri-yaml}[YAML] data (single-line form).
