...
When you are ready for a release, first set the version in the file [path]_lib/jekyll-asciidoc/version.rb_ and commit the change.

To package, tag and release the gem to RubyGems.org, run the following rake task:
