...
Any AsciiDoc attribute defined in the AsciiDoc document header whose name begins with `page-` (<<customizing-the-page-prefix, cf this>>) gets promoted to a {url-variables}[page variable].
...
Since the attribute value is processed into YAML data, you can build nested data structure using the inline YAML syntax.
